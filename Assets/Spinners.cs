...
public class Spinners : AbstractManualMono
{
    [SerializeField]
    private float numerator = 1f;

    [SerializeField]
    private float denominator = 3f;

    [SerializeField]
    public TimeOfDay timeReference;
    ...
    private float GetValue()
    {
        ...
        switch (timeType)
        {
            ...
            case TimeRef.Second:
                return tr.Second + (tr.Millisecond / MILLIS_PER_SECOND);
            default:
                return tr.Second;
        }
    }
    ...
    public override void ManualUpdate()
    {
        this.transform.localEulerAngles = new Vector3(
            0,
            0,
            90 - GetValue() * (numerator / denominator)
        );
    }
}
